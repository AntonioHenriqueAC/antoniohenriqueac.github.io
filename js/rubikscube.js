...
const BUTTONS = {
  Menu: [ 'stats', 'prefs', 'back2' ],
  Playing: ['back', 'back2'],
  Complete: [],
  Stats: [],
  Prefs: ['back', 'theme', 'back2'],
  Theme: ['back', 'reset', 'back2'],
  None: [],
};
...
class Game {
  ...
  constructor() {
    ...
    this.dom = {
      ...
      back2: document.querySelector( '.ui__background' ),
      ...
      buttons: {
        ...
        back2: document.querySelector('.btn--back2'),
...
this.dom.buttons.back2.onclick = event => {
